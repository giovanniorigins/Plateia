...
angular.module('common', [
    ...
    .factory('$cordovaDevice', ['supersonic', function (supersonic) {
        var _getPlatform = function () {
            supersonic.logger.log('Platform');
    ...
    .controller('BodyController', ['$scope', 'AppData', 'supersonic', function ($scope, AppData, supersonic) {
        $scope.ADappState = AppData.AppState;
        $scope.list = ['test'];

        supersonic.logger.log('App Ready');
